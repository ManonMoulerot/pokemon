<?php
    //rappeler l'objet et la function pour la regenerer un coup
      ...
      $pokemon = new Pokemon();
        ...
        echo "<ul class='row justify-content-center flex-column pl-0'>";
   while ($resultrow2=$listePokemonDefensif->fetch(PDO::FETCH_ASSOC)) {
        echo "<li class='d-flex font-size1 font-weight-bold text-center flex-column'><div class='pl-2 pr-2'><img src='".$resultrow2['img_type']."' alt='".$resultrow2['nom_type']."'></div>
        <span class='pl-2 pr-2 font-weight-light'>ou</span></li>";
